...
class MessageOptions {
  const MessageOptions({
    ...
    this.messagePadding =
        const EdgeInsets.only(top: 6, left: 9, bottom: 5, right: 3),
    this.maxWidth,
    ...
    this.timePadding = const EdgeInsets.only(top: 0),
    this.callhight = 21,
    this.calltextsize = 14,
    this.callpading = const EdgeInsets.all(3),
    Color? timeTextColor,
  ...
  final double? callhight;
  final double? calltextsize;
  final EdgeInsetsGeometry? callpading;
